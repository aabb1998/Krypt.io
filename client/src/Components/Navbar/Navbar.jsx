...
const Navbar = () => {
	...
	return (
		<nav className="w-full flex md:justify-around justify-between items-center p-4 select-none navbar">
			...
			<ul className="flex list-none flex-row justify-between items-center p-4">
				...
				<div className="">
					<button className=" text-white bg-[#3861FB] py-2 px-7 mx-4 rounded-[15px] cursor-pointer hover:text-black">
						Login
					</button>
				</div>
			</ul>
